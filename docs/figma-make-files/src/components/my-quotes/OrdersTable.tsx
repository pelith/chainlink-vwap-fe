...
export function OrdersTable({ orders, onCancelOrder, activeTab }: OrdersTableProps) {
            ...
            return (
              <tr key={order.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <td className="px-4 py-4 whitespace-nowrap">
                  <div className="text-sm font-medium text-gray-900 dark:text-white">{order.pair}</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">
                    {order.direction === 'SELL_WETH' ? 'Sell WETH' : 'Sell USDC'}
                  </div>
                </td>
                <td className="px-4 py-4 whitespace-nowrap">
                ...
                <td className="px-4 py-4 whitespace-nowrap">
                  <div className={`text-sm font-medium ${
                    order.delta >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                  }`}>
                ...
                <td className="px-4 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900 dark:text-white">
                    {formatAmount(order.minAmountOut, receiveToken)} {receiveToken}
                  </div>
                </td>
                <td className="px-4 py-4 whitespace-nowrap">
